...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.skill-item, .portfolio-item, .contact-item, .stat');
...
// Запуск анимации навыков при появлении секции
...
// Запуск анимации печатания при загрузке страницы
...
const fadeInElements = document.querySelectorAll('.about-text, .about-stats, .skill-category, .portfolio-item');
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('Сайт-визитка загружен успешно!');
    
    // Добавление эффекта частиц в hero секции (опционально)
    createParticles();
});
